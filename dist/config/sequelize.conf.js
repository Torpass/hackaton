...
const PatientDB = db_1.sequelize.define("patient", models_1.PatientModel, { timestamps: true });
...
const ReturnDB = db_1.sequelize.define("return", models_1.ReturnModel, { timestamps: true });
exports.ReturnDB = ReturnDB;
const ReturnDetailsDB = db_1.sequelize.define("return_details", models_1.ReturnDetailsModel, { timestamps: true });
exports.ReturnDetailsDB = ReturnDetailsDB;
const AdminDB = db_1.sequelize.define("admin", models_1.AdminModel, { timestamps: true });
