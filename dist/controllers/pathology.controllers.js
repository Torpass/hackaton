...
class PathologyController {
    ...
    patientCount(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { status, message, data } = yield (0, pathology_service_1.patientCount)();
                return res.status(status).json({
                    message, data
                });
            }
    ...
    delete(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const { status, message } = yield (0, pathology_service_1.deletePathology)(parseInt(id));
                return res.status(status).json({
                    message
                });
            }
    ...
    getAllActive(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { status, message, data } = yield (0, pathology_service_1.getAllActive)();
                return res.status(status).json({
                    message, data
                });
            }
