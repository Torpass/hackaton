...
router.delete("/delete/:id", communityController.delete);
router.get("/getAllActives", communityController.getAllActivities);
router.get("/getAll", verifyTokem_middleware_1.verifyToken, communityController.getAllActivities);
