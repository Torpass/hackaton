...
router.post('/create',adminValidator.createValidate, validateFields ,adminController.create);
router.post('/login', adminController.login);
router.post('/logout', adminController.logout);
router.put('/update/:id', validateFields,adminValidator.createValidate ,adminController.update);
